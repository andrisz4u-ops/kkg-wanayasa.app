...
async function handleGenerateBySections(monitor, baseInput, tmpl) {
  ...
  const kataP1Map = {
    ...
    'kalender-sekolah': `Puji syukur ke hadirat Tuhan Yang Maha Esa atas tersusunnya dokumen ${judul} Tahun Ajaran ${tahunAjaran} di ${namaSekolah}. Program Kalender Pendidikan Satuan Pendidikan (KPSP) ini disusun sebagai pedoman resmi operasional alokasi waktu efektif pembelajaran, hari libur, dan matriks agenda tahunan sekolah yang berpedoman pada Permendikdasmen No. 13 Tahun 2025 dan Surat Edaran Kadisdik Purwakarta No. 400.3.5/2367-Dikdas/2026.`,
  };
