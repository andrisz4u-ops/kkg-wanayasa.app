...
import analisisCpRoutes from './routes/analisis-cp';
import programSekolahRoutes from './routes/program-sekolah';
...
app.route('/api/analisis-cp', analisisCpRoutes);
app.route('/api/program-sekolah', programSekolahRoutes);
