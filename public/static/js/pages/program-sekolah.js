...
import { downloadProgramDocx, saveProgramToArchive, openProgramArchiveDrawer } from './program-sekolah/downloaders.js';
    ...
    <div class="animate-fade-in max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" id="program-sekolah-page">
      ...
      <div id="program-wizard-section" class="space-y-8">
        ...
        <div class="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200" id="specific-form-box">
          ...
          <!-- AI Model Selection & Action Button -->
          <div class="mt-8 pt-6 border-t border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div class="flex items-center gap-3">
              ...
              <select id="program-ai-model-select" class="text-xs rounded-lg border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 min-w-[200px]">
...
async function handleGenerateProgram() {
  ...
  const monitor = openAiLiveMonitor({
    ...
    subtitle: `${tmpl?.title || 'Program Kerja'} • Format BAB I–V Standar Kedinasan`,
    steps: [
      { id: 1, label: 'Dasar Hukum', icon: 'fa-scale-balanced' },
      { id: 2, label: 'BAB I & II', icon: 'fa-book-open' },
      { id: 3, label: 'Rencana Aksi', icon: 'fa-calendar-check' },
      { id: 4, label: 'Monev & Jurnal', icon: 'fa-clipboard-list' },
