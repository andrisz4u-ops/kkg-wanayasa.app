          ...
          children: [
            ...
            new TableCell({
              ...
              children: [
                new Paragraph({
                  spacing: { before: 100, after: 40 },
                  children: [new TextRun({ text: `Purwakarta, ${titimangsaDate}`, size: 20, font: 'Times New Roman' })]
                }),
                new Paragraph({
                  spacing: { after: 600 },
                  children: [new TextRun({ text: 'Guru Mata Pelajaran / Kelas', bold: true, size: 20, font: 'Times New Roman' })]
                }),
                new Paragraph({
